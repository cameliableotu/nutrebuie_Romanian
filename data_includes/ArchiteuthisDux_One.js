...
[["MODALITYNEGATION-necessarynot",7], "Question", {q:"Ȋn ‘Linda nu trebuie sǎ vorbeascǎ germanǎ. Oaspeţii noştri nu înţeleg germanǎ.’, ‘Linda nu trebuie sǎ vorbeascǎ germanǎ.’ means",as: [['s','E necesar ca Linda sǎ nu vorbeascǎ germanǎ.'],['k','Nu e necesar ca Linda sǎ vorbeascǎ germanǎ.']]},
                                       ...
                                       "AcceptabilityJudgment", {s: "Cât de acceptabilǎ este ‘Linda nu trebuie sǎ vorbeascǎ germanǎ.’ în contextul ‘Linda nu trebuie sǎ vorbeascǎ germanǎ. Oaspeţii noştri nu înţeleg germanǎ.’?"}],
...
[["filler-should",20],  "Question", {q:"In  ‘Nu ar trebui sǎ vorbeşti cu tine însuţi cu blândeţe. Vei sfârşi cu depresie.’, 'Nu ar trebui sǎ vorbeşti cu tine însuţi cu blândeţe.' înseamnǎ ",as: [['s','E necesar sǎ nu-ţi vorbeşti cu blândeţe.'],['k','Nu e necesar sǎ-ţi vorbeşti cu blândeţe.']]},
                        "AcceptabilityJudgment", {s: "Cât de acceptabilǎ este ‘Nu ar trebui sǎ vorbeşti cu tine însuţi cu blândeţe’ în contextul ‘Nu ar trebui sǎ vorbeşti cu tine însuţi cu blândeţe. Vei sfârşi cu depresie.’?"}],
